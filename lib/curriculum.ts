...
export const WEEK_TASKS: Record<number, SeedTask[]> = {
  ...
  2: [
    ...
    { day: 1, title: "React depth", category: "Engineering", estMinutes: 120, description: "Work Managing State, then Escape Hatches, about 60 minutes each, doing every challenge. The challenges are the learning; reading alone does not count.", links: [{ label: "react.dev: Managing State", url: "https://react.dev/learn/managing-state" }, { label: "react.dev: Escape Hatches", url: "https://react.dev/learn/escape-hatches" }] },
    patternStudy(2, "Fast and slow pointers pattern"),
    { day: 2, title: "Next.js fundamentals", category: "Engineering", estMinutes: 120, description: "Work the official interactive course, building the demo app as you go: routing, layouts, data fetching, server components. The JS Mastery video is an optional deeper build to spread across the week, not for today.", links: [{ label: "Next.js Learn (interactive)", url: "https://nextjs.org/learn" }, { label: "JSM Next.js 15 course (video, 7 hr, optional)", url: "https://www.youtube.com/watch?v=3qGQ4dGA42o" }] },
  ...
  3: [
    ...
    { day: 4, title: "Authentication", category: "Engineering", estMinutes: 120, description: "Read The Copenhagen Book's sessions and password chapters (about 45 minutes), then wire Supabase Auth into a throwaway Next.js app: sign-up, sign-in, one protected page.", links: [{ label: "The Copenhagen Book", url: "https://thecopenhagenbook.com" }, { label: "Supabase Auth docs", url: "https://supabase.com/docs/guides/auth" }] },
  ...
  5: [
    ...
    { day: 6, title: "Async and background jobs", category: "Engineering", estMinutes: 90, description: "Read the queue explainer, then move one slow operation into a background job with Inngest in a sandbox app: enqueue it, work it, make it retry on failure.", links: [awsQueues, { label: "Inngest docs", url: "https://www.inngest.com/docs" }] },
